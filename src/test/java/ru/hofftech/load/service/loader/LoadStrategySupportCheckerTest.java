...
class LoadStrategySupportCheckerTest {
    private LoadStrategySupportChecker supportChecker;
    private ParserParcelBuilder parcelBuilder;

    @BeforeEach
    void setUp() {
        supportChecker = new LoadStrategySupportChecker();
    ...
    void hasEnoughSupport_OnFloor_ReturnsTrue() {
        ...
        Parcel parcel = parcelBuilder.buildFromLines("Name", List.of("333", "333")); // 3x2
    ...
    void hasEnoughSupport_FullSupport_ReturnsTrue() {
        ...
        Parcel supportParcel = parcelBuilder.buildFromLines("Name", List.of("333")); // 3x1
        machine = machine.placeParcel(supportParcel, 1, 0);

        Parcel parcel = parcelBuilder.buildFromLines("Name", List.of("333", "333")); // 3x2 - ставим сверху
    ...
    void hasEnoughSupport_ExactlyEnoughSupport_ReturnsTrue() {
        ...
        Parcel supportParcel1 = parcelBuilder.buildFromLines("Name", List.of("1")); // 1x1
        Parcel supportParcel2 = parcelBuilder.buildFromLines("Name", List.of("1")); // 1x1
        Parcel supportParcel3 = parcelBuilder.buildFromLines("Name", List.of("1")); // 1x1
        ...
        Parcel parcel = parcelBuilder.buildFromLines("Name", List.of("55555")); // 5x1 - ставим сверху
