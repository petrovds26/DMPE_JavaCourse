...
class BalancedPackingStrategyTest {

    private BalancedPackingStrategy strategy;
    private ParcelBuilder parcelBuilder;

    @BeforeEach
    void setUp() {
        strategy = new BalancedPackingStrategy();
    ...
    void loadParcels_MultipleParcelsMultipleMachines_DistributesEvenly() {
        // Arrange
        Parcel parcel1 = parcelBuilder.buildFromLines(List.of("111")); // 3x1
        Parcel parcel2 = parcelBuilder.buildFromLines(List.of("222")); // 3x1
        Parcel parcel3 = parcelBuilder.buildFromLines(List.of("333")); // 3x1
        Parcel parcel4 = parcelBuilder.buildFromLines(List.of("444")); // 3x1
        Parcel parcel5 = parcelBuilder.buildFromLines(List.of("555")); // 3x1
        Parcel parcel6 = parcelBuilder.buildFromLines(List.of("666")); // 3x1
    ...
    void getAlgorithmType_ReturnsCorrectType() {
        // Act & Assert
        assertThat(strategy.getAlgorithmType()).isEqualTo(ParcelLoadingStrategyType.BALANCED_PACKING);
    ...
    void loadParcels_ParcelWithHoles_PlacesCorrectly() {
        // Arrange
        Parcel parcel = parcelBuilder.buildFromLines(List.of("999", "9 9", "999")); // 3x3 с дыркой
